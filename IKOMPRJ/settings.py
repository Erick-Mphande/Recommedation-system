"""
Django settings for IKOMPRJ project.
...
SECRET_KEY = 'django-insecure-4e+r^il-xwh2eezgk@q4iyv_89%iaj+r)#p3h_@asifsvzcnf7'
...
WSGI_APPLICATION = 'IKOMPRJ.wsgi.application'
